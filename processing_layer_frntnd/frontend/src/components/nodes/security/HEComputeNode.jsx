...
export default memo(({ id, data, selected }) => {
  ...
  return (
    ...
    >
      <Handle type="target" position={Position.Left} id="data" style={{ left: -6, top: '50%', background: 'var(--accent-blue)', width: 12, height: 12, border: '2px solid var(--bg-surface)', zIndex: 10 }} />
