...
import { Database, Brain, Filter, Zap, ChevronLeft, ChevronRight, Activity, Sigma, Minus } from 'lucide-react';
                    ...
                    <div style={{ display: 'flex', flexWrap: 'wrap', gap: 8 }}>
                        {view === 'logic' && (
                            <>
                                ...
                                <div className="dndnode input" onDragStart={(e) => onDragStart(e, 'subtract')} draggable style={{ padding: '8px 12px', fontSize: '0.75rem', gap: 6, background: 'var(--bg-elevated)' }}>
                                    <Minus size={14} color="#34d399" />
                                    Subtract
                                </div>
                            </>
                        )}
